...
<div class="container">
	...
	<!--Panel-->
	<div class="card">
		<h3 class="card-header mdb-color lighten-2 white-text" id="jdk-18">Java Development Kit 1.8</h3>
		<div class="card-body">
			<h4 class="card-title">Java es un pre-requisito</h4>
		...
		<div class="card-body">
			<h4><span class="badge badge-pill indigo lighten-1">Cosas a tener en cuenta</span></h4>
			<ul> 
	...
	<!--Panel-->
	<div class="card">
		<h3 class="card-header mdb-color lighten-2 white-text" id="instalar-wollok">Bajarse el entorno Wollok</h3>
		<div class="card-body">
	...
	<!--Panel-->
	<div class="card">
		<h3 class="card-header mdb-color lighten-2 white-text" id="troubleshooting">Problemas comunes al instalar Wollok</h3>
		<div class="card-body">
	...
	<!--Panel-->
	<div class="card">
		<h3 class="card-header mdb-color lighten-2 white-text" id="configuraciones-extras">Configuraciones extras</h3>
		<div class="card-body" id="apuntando-la-jdk-correcta-en-tu-entorno">
