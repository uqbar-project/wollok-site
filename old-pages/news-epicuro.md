...
Recordá que podés buscar clases de la bibliotecas nativa Wollok presionando Ctrl + Shift + F3 y escribiendo el nombre de la clase deseada:
...
## Bibliotecas
Hubo un gran cambio en las bibliotecas nativas de Wollok. Ahora tenés varios archivos .wlk más cortos y extensibles:
